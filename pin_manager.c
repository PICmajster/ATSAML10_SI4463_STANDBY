...
PORT->Group[0].OUTSET.reg = PORT_PA16 ;//Set pin PA16 PULL UP 

PORT->Group[0].PINCFG[3].bit.PULLEN = 1 ;//Set pin PA03 PULL Enable
PORT->Group[0].OUTSET.reg = PORT_PA03 ;//Set pin PA03 PULL UP 
