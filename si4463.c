...
//------------------------------- SI4463_OFF_32kHz ----------------------------
void SI4463_OFF_32kHz( void )
{
	uint8_t send_stream[] = { SI4463_CMD_SET_PROPERTY, 0x00, 0x01, 0x00, 0x00 };
        SI4463_Send_With_CTS( send_stream, 5 );
}

//------------------------------- SI4463_OFF_WUT ----------------------------
void SI4463_OFF_WUT( void )
{
	uint8_t send_stream[] = { SI4463_CMD_SET_PROPERTY, 0x00, 0x04, 0x00, 0x00 };
        SI4463_Send_With_CTS( send_stream, 5 );
}
